...
// if the all the towers are 1, player 1 can't move so player 2 wins.  If the number of towers is even, player 2 wins, if it's odd player 1 wins
function towerBreakers(numTowers: number, towerHeight: number) {
    return towerHeight === 1 || numTowers % 2 === 0 ? 2 : 1
}
