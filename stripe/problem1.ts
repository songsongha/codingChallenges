...
set of languages that we do support. Write a function that receives two arguments: 
    1. an Accept-Language header value as a string and
    2. set of supported languages, 
...
same order as they appeared in the header). In addition to writing this function, 
you should use tests to demonstrate that it's correct, either via an existing
testing system or one you create. 

Examples: 
parse_accept_language( 
    "en-US, fr-CA, fr-FR", 
the client's Accept-Language header, a string 
["fr-FR", "en-US"] 
the server's supported languages, a set of strings 
